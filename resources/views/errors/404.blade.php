...
<body>
		   	...
		   	<div class="row">
		   		...
		   		<div class="col-seven tab-full social-links pull-right">
		  			...
		  			<div class="col-five tab-full bottom-links">
				   	...
				   	<div class="credits">
				   		<p>Design by <a href="http://www.styleshout.com/" title="styleshout">Yoko Surya Wiguna</a></p>
				   	</div>
			   	</div>   		   		
   ...
   <!-- Java Script
   ================================================== --> 
   <script src="{{ url('404/js/jquery-2.1.3.min.js') }}"></script>
   <script src="{{ url('404/js/plugins.js') }}"></script>
   <script src="{{ url('404/js/main.js') }}"></script>
