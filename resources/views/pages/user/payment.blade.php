                    ...
                    <div class="col-lg-4 mt-2">
                       <div class="card card-details card-right">
                        ...
                        <div class="booking-container">
                            <a href="" class="btn btn-block btn-booking-now mt-3 py-2" data-toggle="modal" data-target="#exampleModal">
                                Continue to Payment
                            </a>

                             <!-- Modal -->
                     <form action=" {{ route('mail',['pemesanan'=>$pemesanan])}}" method="POST">
                        @csrf
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Payment Instruction!!</h5>
